...
from openimagingdatamodel.ontology_tools.repository import AnatomicLocationRepository, AsyncAnatomicLocationRepository
...
@pytest.mark.parametrize("search_term, count", [("brain", 5), ("heart", 5)])

...
async def create_embedding_for_snomedctconcept(concept: SnomedCTConcept, dimensions: int = 1024) -> SnomedCTConcept:
    ...
    response = openai_client.embeddings.create(input = [input_text], model="text-embedding-3-small", dimensions=dimensions)
